...
interface DynamicAreaChartProps {
    ...
    // Area curve type (monotone creates smooth curves)
    curveType?: 'linear' | 'basis' | 'monotone' | 'natural';
}
    ...
    const { transformedData, uniqueProjects } = useMemo(() => {
        ...
        data.forEach(entry => {
            ...
            dateGroups[formattedDate][entry.AUTHORIZED_CONTRACT] =
                (dateGroups[formattedDate][entry.AUTHORIZED_CONTRACT] as number || 0) + entry.NUM_WALLETS;
        });
    ...
    return (
        <ResponsiveContainer width="100%" height={height}>
            ...
            >
                ...
                {/* Dynamically render areas for each unique project */}
